        ...
        <nav class="wf2">
          <div class="nav-wrapper">
            ...
            <ul class="right hide-on-med-and-down">
                <li><a href="{{URL::to('/docent')}}">Home</a></li>
                <li><a href="{{URL::to('/docent/overzicht')}}">Overzicht</a></li>
                <li><a href="{{URL::to('/docent/profiel')}}">Profiel</a></li>
  ...
  <footer class="page-footer wf1_text" style="background-color: #074883;">
    <div class="container">
      <div class="row">
        <div class="col l6 s12">
          <h5 class="white-text">
            <img src="../img/logo.png" alt="E-register logo" width="25%" height="25%">
          </h5>
          <p class="grey-text text-lighten-4">Eregister programma van team 11
            <p>
              <b>Docentpagina</b>
            </p>
          </p>
        ...
        <div class="col l4 offset-l2 s12">
          <h5 class="white-text">
            <i class="medium material-icons">insert_link</i>Links</h5>
          <ul>
            <li>
              <a class="grey-text text-lighten-3" href="https://www.windesheimflevoland.nl/?gclid=Cj0KCQjwl7nYBRCwARIsAL7O7dEJcFXckC4t0DHW3gpin2kaLcod13-eEzU0C-jydbJWLyzlnG3SDP8aAtx5EALw_wcB">Windesheim Flevoland</a>
            </li>
            <li>
              <a class="grey-text text-lighten-3" href="https://startpagina.windesheim.nl/default.aspx">Sharenet</a>
            </li>
            <li>
              <a class="grey-text text-lighten-3" href="https://elo.windesheim.nl/Start.aspx#51">ELO</a>
            </li>
            <li>
              <a class="grey-text text-lighten-3" href="https://educator.windesheim.nl/studyprogress?3">Educator</a>
            </li>
          </ul>
        </div>
      </div>
