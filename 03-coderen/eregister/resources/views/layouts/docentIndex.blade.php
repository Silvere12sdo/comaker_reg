...
<body class="#000">
    <div class="navbar-fixed">
        <nav class="wf2">
          ...
          <a href="{{URL::to('/')}}" class="brand-logo center">
              ...
              <img src="{{URL::asset('img/logo.png')}}" alt="E-register logo" width="35%" height="35%">
              </div>
            </a>
    ...
    <footer class="page-footer wf1_text" style="background-color: #074883;">
        <div class="container">
          <div class="row">
            <div class="col l6 s12">
              <h5 class="white-text"><img src="{{URL::asset('img/logo.png')}}" alt="E-register logo" width="25%" height="25%"></h5>
              <p class="grey-text text-lighten-4">Eregister programma van team 11 <p> 
                 <b>Docentpagina</b></p> </p>
            </div>
            <div class="col l4 offset-l2 s12">
