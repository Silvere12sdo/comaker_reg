...
--
-- Host: 127.0.0.1
-- Gegenereerd op: 28 mei 2018 om 00:09
...
(1, 's1117592@student.windesheim.nl', 'c775e7b757ede630cd0aa1113bd102661ab38829ca52a6422ab782862f268646', 0),
...
INSERT INTO `profiel` (`ID`, `gebruiker_ID`, `studentnummer`, `naam`, `tussenvoegsel`, `achternaam`, `postcode`, `plaats`, `straat`, `straatnummer`, `land`) VALUES
...
--
-- Tabelstructuur voor tabel `profiel_klas`
--
...
--
-- Gegevens worden geëxporteerd voor tabel `profiel_klas`
--
...
--
-- Indexen voor tabel `profiel_klas`
--
...
--
-- AUTO_INCREMENT voor een tabel `profiel_klas`
--
ALTER TABLE `profiel_klas`
